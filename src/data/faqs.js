// FAQs for the Super Ultimate Monster Burger page. Rendered as comic accordions
// AND emitted as FAQPage JSON-LD (answer-box / AI citations). Edit freely.
export const monsterFaqs = [
  {
    q: 'Is the Super Ultimate Monster Burger real, or is this a dare disguised as a menu item?',
    a: "Both. It's 8 pounds of homemade burger, grilled onions, ham, and eight fried eggs on a 10-inch house-made bun. It's $60. It is also, technically, a personality test.",
  },
  {
    q: 'Do I have to finish it?',
    a: "Nope. Finishing is optional; bragging is encouraged either way. Most people tap out and take a glorious leftover bag home. Limelight will even slice it so you don't have to wrestle it.",
  },
  {
    q: 'Can I split it with the table?',
    a: "You can, and you'll probably be a hero for suggesting it. Eight eggs go a long way. This burger was built for sharing — or for one very ambitious human.",
  },
  {
    q: 'How big are we actually talking?',
    a: "Eight pounds. A 10-inch bun. Eight eggs. For scale: that's heavier than a newborn and roughly the size of a steering wheel — which is fitting, since we also have a burger on wheels parked outside.",
  },
  {
    q: 'Should I "train" for this?',
    a: 'We admire the commitment. Babyface trains by skipping breakfast. You may want to skip breakfast, lunch, and possibly the day before.',
  },
  {
    q: "Is there a smaller version if I'm not ready for the big leagues?",
    a: 'Yes. Start with The Monster (3 lb, $18) or The Ultimate Monster (4 lb, $25), then work your way up the Monster series like a proper origin story.',
  },
  {
    q: 'What comes with it?',
    a: 'Eight fried eggs, grilled onions, ham, and the quiet respect of everyone in the dining room.',
  },
  {
    q: 'Is it on the menu every day?',
    a: "Every day. We're open 365 days a year, 7 AM to 10 PM. The Monster never sleeps.",
  },
  {
    q: 'Can I get it for breakfast?',
    a: "With eight eggs on it, one could argue it's already breakfast. We won't stop you.",
  },
  {
    q: 'What if I actually finish the whole thing?',
